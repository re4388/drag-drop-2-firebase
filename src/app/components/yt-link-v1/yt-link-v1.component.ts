...
@Component({
  selector: 'app-yt-link-v1',
  templateUrl: './yt-link-v1.component.html',
  styleUrls: ['./yt-link-v1.component.css'],
})
export class YtLinkV1Component implements OnInit, AfterViewInit {
  allTasks: any = [];
  todo: any = [];
  done: any = [];
